...
# Derived from https://github.com/nholuongut/openapi2jsonschema
import yaml
import json
import sys
import os
...
def additional_properties(data, skip=False):
    "This recreates the behaviour of kubectl at https://github.com/nholuongut/kubernetes/blob/225b9119d6a8f03fcbe3cc3d590c261965d928d0/pkg/kubectl/validation/schema.go#L312"
